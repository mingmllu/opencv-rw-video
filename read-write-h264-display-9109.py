...
cap = cv2.VideoCapture('http://root:fitecam@135.222.247.179:9109/mjpg/video.mjpg')
...
out = cv2.VideoWriter('video_h264_11_08_9109.avi',cv2.VideoWriter_fourcc('H', '2', '6', '4'), 10, (frame_width,frame_height))
